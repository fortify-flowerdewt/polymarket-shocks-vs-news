...
<div class="panel panel-main exemplars-panel">
  ...
  <div class="chart-key">
    <span><span class="key-swatch key-price"></span>price (probability)</span>
    <span><span class="key-swatch key-shock"></span>shock moment</span>
    <span><span class="key-swatch key-wiki"></span>Wikipedia edit</span>
  </div>
...
.key-price {
  background: linear-gradient(to top, rgba(96, 165, 250, 0.35), rgba(96, 165, 250, 0.35));
  border-top: 2px solid #1e40af;
}
.key-shock { background: transparent; border-left: 2px dashed #dc2626; border-right: 2px dashed #dc2626; width: 14px; }
.key-wiki  { background: transparent; border-left: 2px dashed #d97706; border-right: 2px dashed #d97706; width: 14px; }
